<x-app-layout>
    <div class="containerh py-8">
        <div class="grid grid-cols-2 gap-6">
            {{-- Este div es el que contiene el flexslider --}}
            <div>
            ...
            {{-- Este div es el que contiene la informacion del producto --}}
            <div>
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-lime-600">Se hace envios a todo México</p>
                            <p>Recibelo el {{ Date::now()->addDay(7)->locale('es')->format('l j F') }}</p>
                        </div>
                    </div>
                </div>

                {{-- Aqui evaluaremos si el producto tiene color o talla --}}
